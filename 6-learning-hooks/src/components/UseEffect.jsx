...
// fn for the first time when the component UseEffect.jsx loads - and inside the fn, count is incremented by
// setCount and we know that with every change of state a compnt reloads, so useEffect runs the callback again
